...
export class OpenAIConverter extends BaseConverter {
    ...
    toClaudeResponse(openaiResponse, model) {
        ...
        // 注意：Claude API 的 thinking 块需要 signature 字段
        // 我们过滤掉 OpenAI 的 reasoning_content，使用 Claude 原生的 Extended Thinking 代替
        // 如果需要在 Claude Code 中看到 thinking，请在请求中设置 thinking: { type: "enabled", budget_tokens: 10000 }
        // const reasoningContent = choice.message?.reasoning_content || "";
        // 完全忽略 reasoning_content
